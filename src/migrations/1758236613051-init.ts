...
export class Init1758236613051 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`CREATE TABLE "Users" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "hashedPassword" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UniqueUserName" UNIQUE ("name"), CONSTRAINT "PK_16d4f7d636df336db11d87413e3" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "TransactionDocuments" ("id" SERIAL NOT NULL, "documentURI" text NOT NULL, "transactionId" integer, CONSTRAINT "PK_8488f8e87bde7dacf065cec4cbb" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "TransactionForwards" ADD CONSTRAINT "FK_ac1bfcbb0439db7985d95c5d65e" FOREIGN KEY ("senderId") REFERENCES "Users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "TransactionForwards" ADD CONSTRAINT "FK_828167d3816091e1bba66fd4e8c" FOREIGN KEY ("receiverId") REFERENCES "Users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
